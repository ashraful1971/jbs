        ...
        <div class="container mx-auto px-6">
            ...
            <div class="md:flex md:space-x-10">
                ...
                <div class="bg-white box-shadow p-6 rounded my-6 border-l-4 border-accent">
                    ...
                    <p class="text-gray-700">{$announcement->getLocalizedDescriptionShort()|strip_unsafe_html|strip_tags}</p>
                </div>
                <!-- item end -->
                {/foreach}
            </div>
            ...
            <div class="sm:flex space-y-10 sm:space-y-0 sm:space-x-10">
                ...
                <div class="box-shadow rounded flex-none w-full sm:w-1/3">
                    ...
                    <a class="hover:text-gray-800" href="{url op="view" page="issue" path=$issue->getBestIssueId()}">
                        <img class="w-full rounded box-shadow" src="{$issueCover|escape}" alt="{translate key="issue.viewIssueIdentification" identification=$issue->getIssueIdentification()|escape}">
                    </a>
                    {/if}
                </div>
                <!-- Issue cover end -->
                ...
                <div class="flex-grow">
                    ...
                    <!-- Articles start -->
                            {if $section.title} 
                            <h2 class="font-bold text-2xl mb-4 mt-8">{$section.title|escape}</h2>
                            {/if}
